...
import { Bot, Sparkles, Pencil, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 md:py-24 relative overflow-hidden isolate">
      ...
      <Image
        ...
        src="https://picsum.photos/seed/imacalllogo3/180/180"
        alt="Imacall Logo"
        width={180}
        height={180}
        className="rounded-full mb-8 shadow-xl border-4 border-background/80 backdrop-blur-sm animate-in fade-in zoom-in-90 duration-500"
        priority
      />
